    ...
    <section id='contact' className="text-white font-bold text-[30px] ml-12 relative">
      <div className="flex flex-col">
        <div className="xl:w-[60%] pr-8">
          ...
          <div className="mt-20 text-[44px] mr-2 ml-1 phone:text-[30px]">GOT AN EXCITING PROJECT YOU WANT TO COLLABORATE ON?</div>
          <div>
            <div className="w-full mr-5 xl:absolute right-0 top-12 xl:w-1/2 md:ml-1"> 
              ...
              <div className='flex flex-col mt-5 mr-5 pl-3 xl:ml-32 phone:pl-0'>
          ...
          <div className='mt-10 flex flex-col text-white text-[30px] font-metro phone:text-[20px]'>
                  <a className='group relative mt-2' href="mailto: simeon.tho23@gmail.com">SIMEON.THO23@GMAIL.COM
                    <div className='absolute inset-0 ml-3 mt-4 bg-[#1E1E1E] w-[440px] phone:w-[290px] phone:h-6 h-10 z-[-5] group-hover:h-12 group-hover:-translate-y-3 duration-300 mr-[24%]'></div>
                  </a>
                  <div>
                    <a className='mt-20 flex items-center group phone:mt-16' href="https://github.com/stho23" target="_blank">GITHUB&#160;
                    ...
                    <a className='mt-8 flex items-center group' href="" target="_blank">TWITTER&#160;
                    <RxArrowTopRight className='text-[30px] group-hover:text-teal transform translate-x-0 translate-y-0 group-hover:translate-x-2 group-hover:-translate-y-2 transition-transform duration-300'></RxArrowTopRight></a>
      ...
      <img src={contactLogo} alt="" className='absolute bottom-0 pb-1 z-[-20] w-[580px] sm:ml-18 md:ml-24 lg:right-5 xl:left-0'/>
        <div className='bg-white h-0.5 w-full mt-12'>
          <div className='pt-10 flex flex-row font-metro text-[18px] phone:text-[12px]'>
